...
class TVDiscoverToday extends Component {
  ...
  componentDidMount = () => {
    ...
    axios
      .get(
        `${BASE_REQUEST}/tv/airing_today?api_key=${API_KEY}&language=en-US&page=${page}`
      )
      .then(res =>
        this.setState({
  ...
  onForward = e => {
    ...
    this.props.history.push(`/tv/discover/${newPage}/airing_today`);
  };
  ...
  render() {
    ...
    return (
      <div className="Discover">
        <TaskBar type={"airing_today"} categorie="tv" />
...
export default withRouter(TVDiscoverToday);
